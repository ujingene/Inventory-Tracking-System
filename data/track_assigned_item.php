    ...
    while($row = $result->fetch_assoc()) {
		?>
			<tr>
				...
				onclick="item_profile('<?php echo $row['item_id']; ?>');">
					<strong>
                ...
                <td align="center">
				<a href="../data/return_item.php?inventoryID=<?php echo $row['id'];?>"
                    onclick="return confirm('Return <?php echo $row['item_name']; ?> curently held by <?php echo $row['emp_fname']; ?>');"><button class="btn btn-warning btn-sm"> Return </button>
				</a>
				</td>
			</tr>
		<?php
