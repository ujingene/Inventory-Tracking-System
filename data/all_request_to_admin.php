 	...
 	<?php foreach($results as $r):
 	 ...
 	 ?>
 		<tr>
 			...
 			<td>
 				<div class="center">
 					<button onclick="request_action('2', '<?= $id; ?>', '<?= $iid; ?>', '<?= $req_type; ?>')" type="button" class="btn btn-success btn-sm">Start Request <span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button>
 					<button onclick="request_action('3', '<?= $id; ?>', '<?= $iid; ?>', '<?= 'reject'; ?>')" type="button" class="btn btn-danger btn-sm">Suspend Request <span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
 				</div>
 			</td>
 		</tr>
	<?php endforeach; ?>
