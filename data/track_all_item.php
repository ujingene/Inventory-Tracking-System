    ...
    <tbody>
		...
		?>
			<tr>
				...
				<?php if($fN == "-"){ ?>
				<td align="center">
					<button onclick="fill_update_modal('<?php echo $i['item_id']; ?>');" class="btn btn-success btn-sm"
				...
				<?php } else { ?>
				<td align="center">
					<button class="btn btn-warning btn-sm" onclick="item_profile('<?php echo $i['item_id']; ?>');">
