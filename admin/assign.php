<?php 
include_once('../data/admin_session.php');//check if session otherwise e return login
  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid">
  	  ...
  	  <ul class="nav navbar-nav">
  	    ...
  	    <li class="active">
          <a href="item.php"><span class="glyphicon glyphicon-object-align-vertical"></span> Inventory
          </a>
        </li>
        ...
        <li>
          <a href="office.php"><span class="glyphicon glyphicon-home"></span> Department</a>
        </li>
	...
	<div id="right_content" >
        ...
        All Inventory Items</div>
  	  			<div class="panel-body">
              <!-- main content -->
                <div id="assignInventory"></div>
              <!-- /main content -->
              <br />
  	  			</div>
 			 </div>
...
<!-- navigation menu -->
<?php require_once('side-menu2.php'); ?>
<!-- navigation menu -->
