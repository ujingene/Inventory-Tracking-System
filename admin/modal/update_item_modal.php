				...
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itemName-update">Inventory Name:</label>
					    <div class="col-sm-9">
				    ...
				    <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-3"> 
					    	<select name="" class="btn btn-default" id="conID-update">
					    		<?php 
					    		...
					    		?>
								<option value="<?php echo $conID; ?>"><?php echo $conDesc; ?></option>
					    		<?php
					    			}//end foreach cond
					    		 ?>
					    	</select>
